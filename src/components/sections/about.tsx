...
export function About() {
  return (
    <section id="about" className="relative pt-32 pb-40 max-w-7xl mx-auto px-5">
      <div className="flex flex-col lg:flex-row-reverse gap-16 lg:gap-28">
        {/* text */}
        <div className="">
        ...
        {/* illustration */}
        <div className="w-full h-[20rem] md:w-[33.625rem] md:h-[33.625rem] rounded-full bg-transparent border border-[#F8F8F845] p-4 md:p-8 relative z-10">
